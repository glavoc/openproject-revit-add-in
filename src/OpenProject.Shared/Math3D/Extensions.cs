...
namespace OpenProject.Shared.Math3D
{
  public static class Extensions
  {
    ...
    /// <summary>
    /// Converts a double value to a decimal value without throwing a <see cref="OverflowException"/>.
    ...
    /// <summary>
    /// Converts a float value to a decimal value without throwing a <see cref="OverflowException"/>.
