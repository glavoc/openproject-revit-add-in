...
{
  /// <summary>
  /// This immutable class describes a directed location in 3d space.
  /// It contains a center point and a forward and up vector to
  /// describe a defined orientation in 3d space.
  /// </summary>
